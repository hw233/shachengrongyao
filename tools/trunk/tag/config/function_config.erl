...
get_list() ->
	[  
 	...
 	#function_conf{
		...
		begin_time = {0,{0,0}},
		end_time = {3,{0,0}},
		consume = [{1,[{1,200},{10,1800}]},{2,[{1,500},{10,4500}]},{3,[{1,500},{10,4500}]},{4,[{1,800},{10,7200}]}]
	},  
 	#function_conf{
		id = 72,
 	...
 	#function_conf{
		...
		begin_time = 0,
		end_time = 0,
		consume = [{1,[{1,2000},{5,9500},{10,18000}]},{2,[{1,2000},{5,9500},{10,18000}]},{3,[{1,2000},{5,9500},{10,18000}]}]
	},  
 	#function_conf{
		id = 91,
		name = xmerl_ucs:to_utf8("跨服暗殿每天"),
