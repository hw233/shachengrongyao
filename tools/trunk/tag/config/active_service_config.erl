...
get(12) ->
	#active_service_conf{
		...
		rank = 0,
		value = 1288,
		reward_zhanshi = [{110045,1,1200}],
		reward_fashi = [{110045,1,1200}],
		reward_daoshi = [{110045,1,1200}],
		reward = [],
		num = 1,
		condition_text = 1288,
		min_jade = 0,
...
get(13) ->
	#active_service_conf{
		...
		rank = 0,
		value = 3288,
		reward_zhanshi = [{110045,1,3000}],
		reward_fashi = [{110045,1,3000}],
		reward_daoshi = [{110045,1,3000}],
		reward = [],
		num = 1,
		condition_text = 3288,
		min_jade = 0,
...
get(14) ->
	#active_service_conf{
		...
		rank = 0,
		value = 4000,
		reward_zhanshi = [{110008,1,2000},{110003,1,40}],
		reward_fashi = [{110008,1,2000},{110003,1,40}],
		reward_daoshi = [{110008,1,2000},{110003,1,40}],
		reward = [],
		num = 1,
		condition_text = 4000,
		min_jade = 0,
...
get(15) ->
	#active_service_conf{
		...
		rank = 0,
		value = 8000,
		reward_zhanshi = [{110008,1,2500},{110003,1,45}],
		reward_fashi = [{110008,1,2500},{110003,1,45}],
		reward_daoshi = [{110008,1,2500},{110003,1,45}],
		reward = [],
		num = 1,
		condition_text = 8000,
		min_jade = 0,
...
get(16) ->
	#active_service_conf{
		...
		rank = 0,
		value = 16000,
		reward_zhanshi = [{110008,1,5000},{110003,1,90}],
		reward_fashi = [{110008,1,5000},{110003,1,90}],
		reward_daoshi = [{110008,1,5000},{110003,1,90}],
		reward = [],
		num = 1,
...
get(22) ->
	#active_service_conf{
		...
		rank = 0,
		value = 6901,
		reward_zhanshi = [{110008,0,2000}],
		reward_fashi = [{110008,0,2000}],
...
get(24) ->
	#active_service_conf{
		...
		rank = 0,
		value = 6904,
		reward_zhanshi = [{110008,0,4000}],
		reward_fashi = [{110008,0,4000}],
		reward_daoshi = [{110008,0,400}],
		reward = [{110045,1,1000}],
		num = 1,
		condition_text = <<"">>,
		min_jade = 0,
		max_jade = 0,
...
get(27) ->
	#active_service_conf{
		...
		rank = 0,
		value = 6909,
		reward_zhanshi = [{110008,0,8000}],
		reward_fashi = [{110008,0,8000}],
		reward_daoshi = [{110008,0,800}],
		reward = [{110045,1,2000}],
		num = 1,
		condition_text = <<"">>,
		min_jade = 0,
		max_jade = 0,
...
get(28) ->
	#active_service_conf{
		...
		rank = 0,
		value = 6906,
		reward_zhanshi = [{110008,0,10000}],
		reward_fashi = [{110008,0,10000}],
		reward_daoshi = [{110008,0,1000}],
		reward = [{110045,1,3000}],
		num = 1,
		condition_text = <<"">>,
		min_jade = 0,
		max_jade = 0,
...
get(29) ->
	#active_service_conf{
		...
		rank = 0,
		value = 6910,
		reward_zhanshi = [{110008,0,12000}],
		reward_fashi = [{110008,0,12000}],
		reward_daoshi = [{110008,0,1200}],
		reward = [{110045,1,4000}],
		num = 1,
		condition_text = <<"">>,
		min_jade = 0,
		max_jade = 0
...
get(30) ->
	#active_service_conf{
		...
		rank = 0,
		value = 6911,
		reward_zhanshi = [{110008,0,13000}],
		reward_fashi = [{110008,0,13000}],
		reward_daoshi = [{110008,0,1300}],
		reward = [{110045,1,5000}],
		num = 1,
		condition_text = <<"">>,
		min_jade = 0,
		max_jade = 0
