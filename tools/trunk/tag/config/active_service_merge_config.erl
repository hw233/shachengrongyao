...
get(22) ->
	#active_service_merge_conf{
		...
		rank = 0,
		value = 6916,
		reward_zhanshi = [{110008,0,14000},{110167,1,2},{110193,1,10}],
		reward_fashi = [{110008,0,14000},{110167,1,2},{110193,1,10}],
		reward_daoshi = [{110008,0,14000},{110167,1,2},{110193,1,10}],
		reward = [],
		num = 1,
		condition_text = <<"">>,
		min_jade = 0,
...
get(23) ->
	#active_service_merge_conf{
		...
		rank = 0,
		value = 6917,
		reward_zhanshi = [{110008,0,16000},{110167,1,2},{110193,1,10},{110054,1,5}],
		reward_fashi = [{110008,0,16000},{110167,1,2},{110193,1,10},{110054,1,5}],
		reward_daoshi = [{110008,0,16000},{110167,1,2},{110193,1,10},{110054,1,5}],
		reward = [],
		num = 1,
		condition_text = <<"">>,
		min_jade = 0,
...
get(73) ->
	#active_service_merge_conf{
		...
		rank = 0,
		value = 1,
		reward_zhanshi = [{110008,0,100000}],
		reward_fashi = [{110008,0,100000}],
		reward_daoshi = [{110008,0,100000}],
		reward = [],
		num = 0,
		condition_text = <<"">>,
		min_jade = 0,
