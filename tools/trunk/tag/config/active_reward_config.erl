...
get({7 ,PlayerLv}) when PlayerLv >=1 andalso PlayerLv =< 999 ->
	#active_reward_conf{
		...
		type = 1,
		value = 7,
		reward = [{110045,1,10000},{110049,1,10}],
		reward_zhanshi = [{110045,1,10000},{110049,1,10}],
		reward_fashi = [{110045,1,10000},{110049,1,10}],
		reward_daoshi = [{110045,1,10000},{110049,1,10}],
		counter_id = 10030
	};
...
get({28 ,PlayerLv}) when PlayerLv >=1 andalso PlayerLv =< 999 ->
	#active_reward_conf{
		...
		type = 4,
		value = 47,
		reward = [{200026,1,1},{110080,1,20},{110045,1,2000},{110127,1,50}],
		reward_zhanshi = [{200026,0,1},{110080,1,20},{110045,1,2000},{110127,1,50}],
		reward_fashi = [{201026,0,1},{110080,1,20},{110045,1,2000},{110127,1,50}],
		reward_daoshi = [{202026,0,1},{110080,1,20},{110045,1,2000},{110127,1,50}],
		counter_id = 10052
	};
...
get({29 ,PlayerLv}) when PlayerLv >=1 andalso PlayerLv =< 999 ->
	#active_reward_conf{
		...
		type = 4,
		value = 50,
		reward = [{200023,1,1},{110081,1,10},{110045,1,3000},{110148,1,1}],
		reward_zhanshi = [{200023,0,1},{110081,1,10},{110045,1,3000},{110148,1,1}],
		reward_fashi = [{201023,0,1},{110081,1,10},{110045,1,3000},{110148,1,1}],
		reward_daoshi = [{202023,0,1},{110081,1,10},{110045,1,3000},{110148,1,1}],
		counter_id = 10053
	};
...
get({30 ,PlayerLv}) when PlayerLv >=1 andalso PlayerLv =< 999 ->
	#active_reward_conf{
		...
		type = 4,
		value = 55,
		reward = [{200039,1,1},{110083,1,10},{110045,1,5000},{110149,1,1}],
		reward_zhanshi = [{200039,1,1},{110083,1,10},{110045,1,5000},{110149,1,1}],
		reward_fashi = [{201039,1,1},{110083,1,10},{110045,1,5000},{110149,1,1}],
		reward_daoshi = [{202039,1,1},{110083,1,10},{110045,1,5000},{110149,1,1}],
		counter_id = 10054
	};
